...
namespace PricingApi.Models
{
    public class PagingParameterModel
    {
        ...
        const string defaultSortOrder = "desc";

        public string _sortOrder { get; set; } = "desc";

        public string columnName { get; set; } = "Created";

        public string querySearchName { get; set; } = "Created";
        ...
        public string sortOrder
        {
            ...
            set
            {
                _sortOrder = (value != "asc") ? defaultSortOrder : value;
            }
        }
